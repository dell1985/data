...
df[ df['期货品种'].str.contains('苹果AP') ]#从df中筛选出期货名称为"苹果AP"的数据
#df[df['期货品种'] == '苹果AP']
#-----------------——-数据整理————————————————————————
...
df.sort_values(["会员简称","日期"],ascending=[0,1],inplace=True)#排序，paascending=[0,1]1降序，0升序
...
df.to_csv('data_input/apple_h_m0.csv',index=None)
print(df.head(100))