...
print(df.index)
df.to_csv('data_input/h_cjl.csv',header=None,index=None)
print(df.head(100))
#--------------------生成持买量文件--------------------
df = pd.read_csv('data_input/h_good_1.csv',usecols=[1,2,3,7,8,9])
print(df.index)
df.to_csv('data_input/h_m1.csv',header=None,index=None)
print(df.head(100))

#--------------------生成持卖仓量文件--------------------
df = pd.read_csv('data_input/h_good_1.csv',usecols=[1,2,3,10,11,12])
print(df.index)
df.to_csv('data_input/h_m2.csv',header=None,index=None)
print(df.head(100))
